...
!function(e) {
    ...
    var t = function() {
        ...
        function(e) {
            var t, o, s, a, l = {}, c = {}, u = {}, d = {}, p = Object.prototype.hasOwnProperty, h = [].slice, f = /\.js$/;
            function g(e, t) {
                return p.call(e, t)
            }
            function m(e, t) {
            ...
            t = function(t, n, i, r) {
                ...
                "undefined" === A || "function" === A) {
                    ...
                    t && (o && o.exports !== e && o.exports !== l[t] ? l[t] = o.exports : p === e && $ || (l[t] = p))
                } else
                    t && (l[t] = i)
            }
            ,
            n = i = o = function(n, i, r, l, c) {
                ...
                if (!n.splice) {
                    if ((u = n).deps && o(u.deps, u.callback),
                    !i)
                        return;
                    i.splice ? (n = i,
                    i = r,
                ...
                l = c),
                l ? t(e, n, i, r) : setTimeout(function() {
                    t(e, n, i, r)
                }, 4),
                o
            }
        ...
        t.define("select2/results", ["jquery", "./utils"], function(e, t) {
            ...
            n.prototype.option = function(n) {
                ...
                n.disabled && (delete r["aria-selected"],
        ...
        t.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(e, t, n) {
            ...
            i.prototype.bind = function(t, r) {
                ...
                this.$selection.on("click", ".select2-selection__choice", function(e) {
                    if (!o.options.get("disabled")) {
                        var t = n.GetData(this, "data");
                        o.trigger("unselect", {
                            originalEvent: e,
                            data: t
                        }),
            ...
            i.prototype.selectionContainer = function() {
                return e('<li class="select2-selection__choice"><span class="select2-selection__choice__remove" role="presentation"><i class="fa fa-times"></i></span></li>')
            }
            ,
            i.prototype.update = function(e) {
                if (this.clear(),
        ...
        t.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(e, t, n, i, r, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, $, w, b, A, x, D, S, E, C) {
            function O() {
                this.reset()
            }
            return O.prototype.apply = function(d) {
                ...
                null == d.dropdownAdapter) {
                    ...
                    if (0 !== d.minimumResultsForSearch && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, D)),
                    d.closeOnSelect && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, E)),
                ...
                if (e.isArray(d.language)) {
                    var P = new u;
                    d.language.push("en");
                    for (var I = d.language, k = 0; k < I.length; k++) {
                        var R = I[k]
                          , U = {};
                        try {
                            U = u.loadPath(R)
        ...
        t.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function(e, t, n, i) {
            ...
            return r.prototype.fromElement = function(e) {
                ...
                o = i._convertData(o);
                for (var s in o)
                    t.inArray(s, n) > -1 || (t.isPlainObject(this.options[s]) ? t.extend(this.options[s], o[s]) : this.options[s] = o[s]);
                return this
            }
            ,
